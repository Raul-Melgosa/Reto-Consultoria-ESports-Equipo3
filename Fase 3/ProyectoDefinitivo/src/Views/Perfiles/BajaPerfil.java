...
private char enmascarador;
    ...
    public BajaPerfil() {
        ...
        this.enmascarador = tfContrasena.getEchoChar();
    }
    ...
    private void initComponents() {
        ...
        barraContrasena = new javax.swing.JSeparator();
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 140, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/pass-white.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, -1, -1));
        ...
        jPanel2.add(tfNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, 260, 30));

        barraNombreUsuario.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 170, 290, 10));
        ...
        jPanel2.add(Baceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 390, -1, -1));

        barraContrasena.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 230, 290, 10));
        ...
        tfContrasena.setText("Contrasena");
        ...
        jPanel2.add(tfContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, 240, 30));
        ...
        jPanel2.add(bVer, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 200, 30, -1));
     ...
     if(validarUsuarioYContra(tfContrasena.getText()))
        {
            ...
            barraContrasena.setForeground(new Color(0,204,0));
        }
        else
        {
            tfContrasena.setForeground(new Color(204,0,0));
            barraContrasena.setForeground(new Color(204,0,0));
        }
    ...
    boolean baja=false;
    baja=Controlador.BajaPerfil(tfNombreUsuario.getText(),tfContrasena.getText());
    if(baja)
         JOptionPane.showMessageDialog(this,"El perfil se ha dado de baja correctamente");
     else
        JOptionPane.showMessageDialog(this,"El perfil no se ha dado de baja correctamente");
    ...
    private javax.swing.JSeparator barraContrasena;
