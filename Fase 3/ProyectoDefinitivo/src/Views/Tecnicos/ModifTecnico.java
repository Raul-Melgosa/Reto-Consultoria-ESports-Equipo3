...
/**
 * Ventana de modificacion de tecnicos
 * @author Equipo 3(Raúl Melgosa, Oier Velar, Alaitz Candela)
 */
public class ModifTecnico extends javax.swing.JFrame {
...
private String tipo="";
    ...
    public ModifTecnico() {
        ...
        Controlador.LlenarComboBoxTecnico(CBtecnico);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificacion Tecnicos");
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, -1, -1));
        jPanel2.add(barraApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 230, 290, 10));
        ...
        jPanel2.add(Baceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 500, 140, 60));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/nickname-white.png"))); // NOI18N
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, -1, -1));
        ...
        jPanel2.add(barraNickname, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 290, 290, 10));
        ...
        jPanel2.add(tfApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, 250, 30));
        ...
        jPanel2.add(tfNickname, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 250, 30));
        ...
        jPanel2.add(tfSueldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 320, 260, 30));

        barraSueldo.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraSueldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 350, 290, 10));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Tipo");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 380, -1, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/equipo-white.png"))); // NOI18N
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 450, -1, -1));
        ...
        jPanel2.add(tfNombreEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 440, 250, 30));

        CBtecnico.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        CBtecnico.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--------Selecciona el tecnico--------", " " }));
        CBtecnico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CBtecnicoActionPerformed(evt);
            }
        });
        jPanel2.add(CBtecnico, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, 300, 30));

        barraNombreEquipo.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraNombreEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 470, 290, 10));
        ...
        jPanel2.add(bPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 380, 90, 40));
        ...
        jPanel2.add(bAsistente, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 380, -1, 40));
    ...
    d=new String[7];
    d=Controlador.DatosTecnico(CBtecnico.getSelectedItem().toString());
    tfApellidos.setText(d[2]);
    tfNickname.setText(d[3]);
    tfSueldo.setText(d[5]);
    tfNombreEquipo.setText(d[4]);
    
    if(d[6].equals("PRINCIPAL"))
         bPrincipal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/principal.png")));
    else
         bAsistente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/asistente.png")));
    ...
    private void tfApellidosFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfApellidosFocusGained
      if(tfApellidos.getText().equals("Apellidos")||tfApellidos.getText().equals(d[2])){
           tfApellidos.setText("");
       }
    ...
    private void tfApellidosFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfApellidosFocusLost
        if(tfApellidos.getText().equals("")){
            if(CBtecnico.getSelectedItem().toString().equals("--------Selecciona el tecnico--------"))
                tfApellidos.setText("Apellidos");
            else
                tfApellidos.setText(d[2]);
    ...
    private void tfNicknameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfNicknameFocusGained
       if(tfNickname.getText().equals("Nickname")||tfNickname.getText().equals(d[3])){
           tfNickname.setText("");
       }
    ...
    private void tfSueldoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfSueldoFocusGained
         if(tfSueldo.getText().equals("Sueldo")||tfSueldo.getText().equals(d[5])){
           tfSueldo.setText("");
       }
    ...
    private void tfNombreEquipoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfNombreEquipoFocusGained
     if(tfNombreEquipo.getText().equals("Nombre Equipo")|| tfNombreEquipo.getText().equals(d[4]))
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifTecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifTecnico().setVisible(true);
            }
        });
    }
