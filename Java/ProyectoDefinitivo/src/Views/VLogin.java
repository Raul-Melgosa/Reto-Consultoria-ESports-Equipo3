...
public class VLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(bModos, new org.netbeans.lib.awtextra.AbsoluteConstraints(-130, 50, -1, -1));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if(menuAbierto)
        {
            ...
            animacion.jLabelXLeft(bModos.getX(), bModos.getX()+300, 3, 5, bModos);
        }
        else
        {
            menuAbierto=true;
            animacion.jLabelXRight(-300, 0, 3, 5, menu);
            animacion.jLabelXRight(bModos.getX(), bModos.getX()-300, 3, 5, bModos);
        }
