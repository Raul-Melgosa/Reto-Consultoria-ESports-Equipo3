...
AnimationClass animacion = new AnimationClass();
    ...
    /**
     * Método para validar que no se escriban caracteres incorrectos en el campo de texto del nombre del equipo
     * @param nombre parametro que contiene la cadena de texto a validar
     * @return 
     */
