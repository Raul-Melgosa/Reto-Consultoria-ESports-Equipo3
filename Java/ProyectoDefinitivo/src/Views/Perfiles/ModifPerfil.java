...
/**
 * Ventana de modificacion de perfiles
...
String [] d;
    ...
    public ModifPerfil() {
        ...
        this.enmascarador = tfPasswd.getEchoChar();
        
        Controlador.LLenarComboBoxPerfil(CBperfil);
    ...
    private void initComponents() {
        ...
        barraNombreUsuario = new javax.swing.JSeparator();
        Baceptar = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        barraPasswd = new javax.swing.JSeparator();
        ...
        jLabel1.setText("Modificacion Perfiles");
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 170, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/pass-white.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 230, -1, -1));
        ...
        jPanel2.add(tfNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 170, 260, 30));

        barraNombreUsuario.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraNombreUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, 290, 10));
        ...
        jPanel2.add(Baceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 480, -1, -1));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 290, -1, -1));

        barraPasswd.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraPasswd, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 290, 10));
        ...
        jPanel2.add(tfEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 290, 250, 30));

        barraEmail.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(barraEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 320, 290, 10));
        ...
        jPanel2.add(bAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 350, -1, -1));
        ...
        jPanel2.add(bUsu, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 350, -1, -1));

        tfPasswd.setBackground(new java.awt.Color(45, 45, 45));
        tfPasswd.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        tfPasswd.setForeground(new java.awt.Color(255, 255, 255));
        tfPasswd.setText("jPasswordField1");
        tfPasswd.setBorder(null);
        tfPasswd.setCaretColor(new java.awt.Color(255, 255, 255));
        tfPasswd.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tfPasswdFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfPasswdFocusLost(evt);
            }
        });
        tfPasswd.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tfPasswdKeyReleased(evt);
            }
        });
        jPanel2.add(tfPasswd, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 230, 210, 30));

        CBperfil.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        CBperfil.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Selecciona un perfil--" }));
        CBperfil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CBperfilActionPerformed(evt);
            }
        });
        jPanel2.add(CBperfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 270, 30));
        ...
        jPanel2.add(bVer, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 230, 30, -1));
    ...
    private void tfPasswdFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPasswdFocusGained
    if(tfPasswd.getText().equals("Contraseña"))
        {
            tfPasswd.setText("");
        }
    }//GEN-LAST:event_tfPasswdFocusGained

    private void tfPasswdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPasswdFocusLost
    if(tfPasswd.getText().equals(""))
        {
            tfPasswd.setText("Contraseña");
            tfPasswd.setForeground(new Color(255,255,255));   
        }
    }//GEN-LAST:event_tfPasswdFocusLost

    private void tfPasswdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfPasswdKeyReleased
     if(validarUsuarioYContra(tfPasswd.getText()))
        {
            tfPasswd.setForeground(new Color(0,204,0));
            tfPasswd.setForeground(new Color(0,204,0));
        }
        else
        {
            tfPasswd.setForeground(new Color(204,0,0));
            barraPasswd.setForeground(new Color(204,0,0));
        }
    }//GEN-LAST:event_tfPasswdKeyReleased
     ...
     if(validarUsuarioYContra(tfNombreUsuario.getText()))
        {
            ...
            barraNombreUsuario.setForeground(new Color(0,204,0));
        }
        else
        {
            tfNombreUsuario.setForeground(new Color(204,0,0));
            barraNombreUsuario.setForeground(new Color(204,0,0));
        }
    ...
    insertado=Controlador.ModificarPerfil(tfNombreUsuario.getText(),tfPasswd.getText(),tfEmail.getText(),tipo);
    if(insertado){
        JOptionPane.showMessageDialog(this,"El perfil ha sido modificado correctamente");
    }
    else
        JOptionPane.showMessageDialog(this,"El perfil no ha sido modificado correctamente");
    ...
    private void CBperfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CBperfilActionPerformed
     d=new String[4];
    d=Controlador.DatosPerfil(CBperfil.getSelectedItem().toString());
    tfNombreUsuario.setText(d[0]);
    tfPasswd.setText(d[1]);
    tfEmail.setText(d[2]);
    ...
    private void bVerMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bVerMouseReleased
        tfPasswd.setEchoChar(enmascarador);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifPerfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifPerfil().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JSeparator barraNombreUsuario;
    private javax.swing.JSeparator barraPasswd;
